...
3. Названия брендов, продуктов, студий, шрифтов и проектов на иностранном языке НЕ переводить. Писать как в оригинале: Apple, Helvetica, Pentagram, Nike Air Max. Не "Найк Эйр Макс".
4. Заголовок: одна строка, 40-80 символов, без точки. Заголовок-тезис, не дословный перевод.
5. Пересказ: 2-3 коротких предложения. Что произошло, о чём материал. Конкретика.
6. Польза: 1-2 предложения — что дизайнер может отсюда забрать (приём, идея, инструмент, наблюдение).
7. Общая длина title + summary + value: до 500 символов.
